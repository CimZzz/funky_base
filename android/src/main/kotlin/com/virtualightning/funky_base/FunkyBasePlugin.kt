...
/** FunkyBasePlugin */
public class FunkyBasePlugin: FlutterPlugin, MethodCallHandler {
  ...
  fun addMethodProcess(processor: BaseMethodProcessor) {
    ...
    methodProcessorMap[processor.methodName] = processor
  }

  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val channel = MethodChannel(flutterPluginBinding.binaryMessenger, "funky_base")
  ...
  companion object {
    @JvmStatic
    fun registerWith(registrar: Registrar, builder: FunkyBasePlugin.() -> Unit) {
      val channel = MethodChannel(registrar.messenger(), "funky_base")
